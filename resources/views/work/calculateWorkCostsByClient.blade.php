...
@section('content')
    ...
    enctype="multipart/form-data">
            ...
            <tr>
                <td>
                    <input id="base_date" class="block w-full px-4 py-3 mb-2 text-sm bg-white border rounded" type="date" name="base_date" value="{{$base_date}}"  max="2382-12-31">まで</td>
                </td>
                <td>
        ...
        <table class='table table-striped'>
            ...
            @foreach ($weekly as $data)
                <tr>
                    <td><a href="{{Route('user.edit',[ 'user' => $data->user_id])}}">{{ $data -> user_name}}</a></td>
